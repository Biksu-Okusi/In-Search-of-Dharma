...
If even one small, poor, unlettered community in the forests of Java could build a whole ethical world from scratch, and defend it for a hundred years, then dharmas are not relics we inherit. They are things people make. Which means that, eventually, they are things *we* could make, too.
