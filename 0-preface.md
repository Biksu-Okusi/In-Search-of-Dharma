...
This is not scripture, and it is not a manual. I hold no lineage and no authority, and there is no practice waiting at the end of these essays that I am quietly selling. Nor is it academic anthropology, though it leans on a great deal of it: the sourcing is real, but the voice is a personal one, written for an intelligent general reader rather than for a subfield. What it is, is one person's attempt to look hard and straight at a single enormous question: what these things called dharmas are, where they come from, and how they get made, with the working kept on show the whole way.
