...
| | |
|---|---|
| **Premise** | *Dharma* is not an exotic Eastern religion-word. It is what every human group does: assemble a way of living — values, stories, practices — that *holds the group together*. There are many; there is no single *The* Dharma. |
...
The eight Parts are not eight topics — they are one movement in five beats:

> **1 · Dissolve** → **2–5 · Establish** *(universal → keystone case → plural → mechanism)* → **6 · Stress-test** → **7 · Pivot** → **8 · Build**

- **Dissolve (1).** Remove the reader's inherited assumption that "dharma" is a vague Buddhist/Hindu spiritual thing. Replace it with a working definition.
...
- **Build (8).** The generative turn. The thesis lands in full.

**Threads planted early and paid off late** (a journey needs setups that close):

- *Can a dharma bind you without a god behind it?* — planted in **Part 1**, made urgent in **Part 7**.

- *If dharmas are plural, are some better than others?* — planted in **Part 1**, resolved into a stance in **Part 8**.

- *The yoga-studio image* the series opens by dissolving (Part 1) returns as a named failure mode — appropriation — in **Part 6**.

- *The intimidator who cannot be shamed* — planted in **Part 2** (the figure on whom the band's ridicule slides off, and against whom it held its last resort), given its biology in **Part 5** ("The Missing Elephant": the constitutionally muted substrate), and paid off in **Part 6** as the predator the anonymous mega-society can no longer watch ("The Wolf in the Flock").

## Status dashboard

Status vocabulary is identical to the research stage:
...
| 2 | The Genesis of Dharmas | Establish · universal | done | [2-birth-of-dharma.md](2-birth-of-dharma.md) |
| 3 | The Dharmas of the Samin of Java | Establish · keystone case | done | [3-samin-of-java.md](3-samin-of-java.md) |
...
| 9 | Coda | — (outside the arc) | done | [9-coda.md](9-coda.md) |
...
*Dissolve. Take the word back from the yoga studio and replace a vague feeling with a working definition.*

- **Reader's question:** What *is* a dharma, really?

- **Opening image:** The word the reader thinks they know — Kerouac's *Dharma Bums*, "good karma," studio décor — set against its actual root.

- **What it covers:** The etymology as the spine of the essay — Sanskrit *√dhṛ* ("to hold, support, sustain"), from Proto-Indo-European *\*dʰer-*, literally *"that which holds"*, a cousin of the English word *firm*. From there: a dharma is whatever **holds a way of life together**. The plural move — there is no single *The* Dharma; secular and religious dharmas sit on the same shelf. The boundary — what separates a *dharma* from mere custom, law, etiquette or ideology (it is comprehensive, identity-constituting, oriented to a good life, and *reflectively self-aware*).
...
### Part 2 — The Genesis of Dharmas

*Establish: universal. Dharmas aren't handed down from mountaintops — they grow, predictably, wherever humans must trust strangers.*

- **Reader's question:** Why does this keep happening, in every society, all over the world?
...
*Establish: the keystone case. One dharma in close-up — proof that a dharma can be made, recently, from the bottom up, by people who left their names.*

- **Reader's question:** What does a living, hand-made dharma actually look like up close?

- **Opening image:** The Saminist deadpan to colonial officials — *"Where are you from?" "From the forest." "Where are you going?" "To the forest."* — or the Kartini Kendeng women sitting outside Indonesia's Presidential Palace in 2016 and 2017 with their feet set in blocks of cement.
...
- **Hands off:** The Samin are one. Pull back and the world is full of them.

### Part 4 — A World of Dharmas

*Establish: plural. Once you can see dharmas, you can't stop seeing them — and they are gloriously, instructively different.*

- **Reader's question:** How different, and how alike, do dharmas get?

- **Opening image:** Five people from five worlds answering the same question — *how should I live?* — and giving five answers that rhyme.
...
- **Hands off:** These systems aren't just *believed* — they're *installed*. How does a dharma get from a page or a chant into your bones?

### Part 5 — How a Dharma Gets Under Your Skin

*Establish: mechanism. A dharma you merely agree with does nothing. The ones that work rewire you.*

- **Reader's question:** Why does a dharma come to feel like plain truth from the inside?

- **Opening image:** The ritual you don't intellectually "believe" that moves you anyway; the convert who changed not their argument but their habits.

- **What it covers:** Jonathan Haidt's moral foundations and the WEIRD-sample critique — your moral intuitions vary across populations and you did not choose them. Ritual, repeated practice and habituation as the *install mechanism* that turns a stated ideal into a lived disposition. The neuroscience of contemplative practice — handled with calibration: the effects are real but routinely oversold. The deep point: a working dharma runs *below* conscious argument, and that is precisely where its power — and its danger — comes from.

- **Draws on:** [5.1 Neurological Basis](5-psychological/5.1-neurological-basis.md), [5.3 Moral Psychology & Development](5-psychological/5.3-moral-psychology-development.md), [5.4 Ritual, Practice & Habituation](5-psychological/5.4-ritual-habituation.md), [5.2 Evolutionary Psychology](5-psychological/5.2-evolutionary-psychology.md), [5.5 Psychopaths](5-psychological/5.5-psychopaths.md) (the missing elephant).

- **Hands off:** Anything this powerful and this far below awareness can drive us off a cliff as easily as toward the good.

### Part 6 — When Dharmas Go Wrong

*Stress-test. Everything that makes a dharma work also makes it dangerous.*

- **Reader's question:** If dharmas are so good for us, why has so much harm been done in their name?

- **Opening image:** A dharma curdling — the in-group bond that becomes a weapon; the liberating practice that becomes a cage.

- **What it covers:** The organising schema is *the dark twin*: every failure of a dharma is one of its strengths over-extended, so the failures are not betrayals of a pure essence but expressions of the real thing (the "that's not real Buddhism" exit closed first). Six twins are named — the fence that becomes a wall, the authority that frees becoming the authority that rules, and the rest — plus the wolf in the flock, the unshameable intimidator planted in Part 2, who is not a twin but games the machinery from inside. Dharma and power: the same machinery that let the Samin *refuse* authority let caste *sanctify* it. Gender, economics and inequality. A worked engineered-dharma twin, with the author's own disclosure. And cultural appropriation and orientalism — the Western yoga-studio "dharma" as a genuine failure mode of cross-cultural borrowing, closing the loop on the image Part 1 opened with.

- **Draws on:** [7.1 Failure Modes](7-critical/7.1-failure-modes.md), [7.2 Appropriation](7-critical/7.2-appropriation.md), [7.3 Dharma & Power](7-critical/7.3-dharma-and-power.md), [7.6 Dogma Undone: The CPA Case](7-critical/7.6-cpa-case.md), [7.7 Dharma by Decree](7-critical/7.7-engineered-dharmas.md), [6.3 Economics, Work & Inequality](6-contemporary/6.3-economics-work-inequality.md), [6.4 Gender & Dharma](6-contemporary/6.4-gender-and-dharma.md), [5.5 Psychopaths](5-psychological/5.5-psychopaths.md).

- **Hands off:** And most of the old dharmas were built for a world that no longer exists. What happens to dharma now?

### Part 7 — Dharmas in a Secular Age

*Pivot. Hundreds of millions now say they're "spiritual but not religious" — not the absence of a dharma, but the search for one without the old foundations.*

- **Reader's question:** Can a dharma survive once its old foundations are gone?

- **Opening image:** The "spiritual but not religious" seeker; the difficulty of holding still under a firehose of information.

- **What it covers:** The secular translation problem — can you keep a dharma's transformative power without its metaphysics? Successes and failures, from Stephen Batchelor's secular Buddhism to mindfulness stripped down to a wellness product. **The grounding problem, now urgent:** can a godless dharma actually *bind* — pay off the thread planted in Part 1. Digital-age terrain — attention, information overload, social media and algorithmic life as new ethical ground. The risk of dharma-as-consumer-product (linking back to Part 6).

- **Draws on:** [6.1 Secular Translation](6-contemporary/6.1-secular-translation.md), [6.2 Digital-Age Dharma](6-contemporary/6.2-digital-age-dharma.md), [3.3 Grounding Problem](3-philosophical/3.3-grounding-problem.md), [3.1 Tension Resolution](3-philosophical/3.1-tension-resolution.md), [6.5 Secularization & the "Nones"](6-contemporary/6.5-secularization-nones.md), [3.5.2–3.5.4 Sumarah cluster](3-philosophical/3.5-sumarah/3.5-sumarah.md) (the Part 4 promise redeemed); carryover from [7.2 Appropriation](7-critical/7.2-appropriation.md).

- **Hands off:** So the question stops being *"which dharma is true?"* and becomes *"can we build a better one, on purpose?"*

### Part 8 — Creating Dharmas

*Build — the destination. We have always made our dharmas; we just told ourselves we found them. Can we now do it consciously, in time, and for a planet?*

- **Reader's question:** Can we make dharmas on purpose — well, and in time?

- **Opening image:** The deliberate design of a new ethic — and the warning standing right beside it.
...
- Each essay carries frontmatter (`part`, `title`, `status`, `words`, `updated`) and ends with the **Sources & further reading** section.

- A shared [`_essay-template.md`](_essay-template.md) (the Stage-2 analogue of [`1-foundational/_template.md`](1-foundational/_template.md)) fixes the structure every essay shares — copy it to `<part>-<slug>.md` and fill it in.

- Update the [status dashboard](#status-dashboard) as each essay moves `todo` → `in-progress` → `review` → `done`.

## Provenance & traceability

This is **Stage 2** of the project's two-stage pipeline (gather, then write; see [`METHODOLOGY.md`](METHODOLOGY.md)). The essays are written *from* the completed, cited research notes — not from scratch. Every substantive claim in an essay must trace either to a research note (which itself carries `[S#]` citations) or to fresh external sourcing flagged at draft time. The prose hides the apparatus; the **Sources & further reading** list preserves the chain. The point of the whole project — traceable evidence behind every claim — survives the move from note to essay.
