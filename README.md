...
The **Preface (Part 0)** has its own set of research notes, held to the same template and citation discipline; they rest substantially on primary self-report and private correspondence, and are kept out of the public repository by design — the one deliberate exception to the open evidence base.
